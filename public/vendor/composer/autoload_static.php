...
class ComposerStaticInit4e70b8b5dd1ea3d4e9f954eca484ca36
{
    ...
    public static $classMap = array (
        'AccountActivationFlow' => __DIR__ . '/../..' . '/src/Services/AccountActivationFlow.php',
        'AuthController' => __DIR__ . '/../..' . '/src/Controllers/AuthController.php',
        'AuthService' => __DIR__ . '/../..' . '/src/Services/AuthService.php',
        'BandaPlanoValidator' => __DIR__ . '/../..' . '/src/Services/BandaPlanoValidator.php',
        'BandaRepository' => __DIR__ . '/../..' . '/src/Repositories/BandaRepository.php',
        'BandaSelectionHelper' => __DIR__ . '/../..' . '/src/Services/BandaSelectionHelper.php',
        'CategoriaController' => __DIR__ . '/../..' . '/src/Controllers/CategoriaController.php',
        'CategoriaFormValidator' => __DIR__ . '/../..' . '/src/Services/CategoriaFormValidator.php',
        'CategoriaRepository' => __DIR__ . '/../..' . '/src/Repositories/CategoriaRepository.php',
        'ChordImportProvider' => __DIR__ . '/../..' . '/src/Services/ChordImportProvider.php',
        'ChordImportProviderResolver' => __DIR__ . '/../..' . '/src/Services/ChordImportProviderResolver.php',
        'ChordSaveNormalizer' => __DIR__ . '/../..' . '/src/Services/ChordSaveNormalizer.php',
        'CifraClubImportProvider' => __DIR__ . '/../..' . '/src/Services/CifraClubImportProvider.php',
        'ClosedBetaPolicy' => __DIR__ . '/../..' . '/src/Services/ClosedBetaPolicy.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'CompromisedPasswordChecker' => __DIR__ . '/../..' . '/src/Services/CompromisedPasswordChecker.php',
        'ConfigController' => __DIR__ . '/../..' . '/src/Controllers/ConfigController.php',
        'Database' => __DIR__ . '/../..' . '/src/Services/Database.php',
        'DatabaseBackupService' => __DIR__ . '/../..' . '/src/Services/DatabaseBackupService.php',
        ...
        'EditorController' => __DIR__ . '/../..' . '/src/Controllers/EditorController.php',
        'GoogleAuthService' => __DIR__ . '/../..' . '/src/Services/GoogleAuthService.php',
        'GoogleCallbackValidator' => __DIR__ . '/../..' . '/src/Services/GoogleCallbackValidator.php',
        'GoogleJwtVerifier' => __DIR__ . '/../..' . '/src/Services/GoogleJwtVerifier.php',
        'HomeController' => __DIR__ . '/../..' . '/src/Controllers/HomeController.php',
        'IndexController' => __DIR__ . '/../..' . '/src/Controllers/IndexController.php',
        'LivePlayerController' => __DIR__ . '/../..' . '/src/Controllers/LivePlayerController.php',
        'LiveStateRepository' => __DIR__ . '/../..' . '/src/Repositories/LiveStateRepository.php',
        'LiveStateService' => __DIR__ . '/../..' . '/src/Services/LiveStateService.php',
        'MailService' => __DIR__ . '/../..' . '/src/Services/MailService.php',
        'MusicController' => __DIR__ . '/../..' . '/src/Controllers/MusicController.php',
        'MusicaRepository' => __DIR__ . '/../..' . '/src/Repositories/MusicaRepository.php',
        'OfflineController' => __DIR__ . '/../..' . '/src/Controllers/OfflineController.php',
        'OperationalLogger' => __DIR__ . '/../..' . '/src/Services/OperationalLogger.php',
        ...
        'PasswordResetFlow' => __DIR__ . '/../..' . '/src/Services/PasswordResetFlow.php',
        'PasswordResetValidator' => __DIR__ . '/../..' . '/src/Services/PasswordResetValidator.php',
        ...
        'PlanoViewModel' => __DIR__ . '/../..' . '/src/Services/PlanoViewModel.php',
        'PlaylistController' => __DIR__ . '/../..' . '/src/Controllers/PlaylistController.php',
        'PlaylistFormValidator' => __DIR__ . '/../..' . '/src/Services/PlaylistFormValidator.php',
        'PlaylistRepository' => __DIR__ . '/../..' . '/src/Repositories/PlaylistRepository.php',
        'PrivacyService' => __DIR__ . '/../..' . '/src/Services/PrivacyService.php',
        'RegisterController' => __DIR__ . '/../..' . '/src/Controllers/RegisterController.php',
        'RoteiroController' => __DIR__ . '/../..' . '/src/Controllers/RoteiroController.php',
        'RoteiroFormValidator' => __DIR__ . '/../..' . '/src/Services/RoteiroFormValidator.php',
        'RoteiroRepository' => __DIR__ . '/../..' . '/src/Repositories/RoteiroRepository.php',
        ...
        'SongController' => __DIR__ . '/../..' . '/src/Controllers/SongController.php',
        'StripeCheckoutHelper' => __DIR__ . '/../..' . '/src/Services/StripeCheckoutHelper.php',
        'StripeWebhookHelper' => __DIR__ . '/../..' . '/src/Services/StripeWebhookHelper.php',
        'SyncConflictException' => __DIR__ . '/../..' . '/src/Services/SyncConflictException.php',
        'SyncRevisionRepository' => __DIR__ . '/../..' . '/src/Repositories/SyncRevisionRepository.php',
        ...
        'TomController' => __DIR__ . '/../..' . '/src/Controllers/TomController.php',
        'UserConfigValidator' => __DIR__ . '/../..' . '/src/Services/UserConfigValidator.php',
        'UserFormValidator' => __DIR__ . '/../..' . '/src/Services/UserFormValidator.php',
        'UserRepository' => __DIR__ . '/../..' . '/src/Repositories/UserRepository.php',
        'UsersController' => __DIR__ . '/../..' . '/src/Controllers/UsersController.php',
        'Validator' => __DIR__ . '/../..' . '/src/Services/Validator.php',
        'YoutubeAudioDownloadService' => __DIR__ . '/../..' . '/src/Services/YoutubeAudioDownloadService.php',
    );
