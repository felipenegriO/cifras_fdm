...
return array(
    'AccountActivationFlow' => $baseDir . '/src/Services/AccountActivationFlow.php',
    'AuthController' => $baseDir . '/src/Controllers/AuthController.php',
    'AuthService' => $baseDir . '/src/Services/AuthService.php',
    'BandaPlanoValidator' => $baseDir . '/src/Services/BandaPlanoValidator.php',
    'BandaRepository' => $baseDir . '/src/Repositories/BandaRepository.php',
    'BandaSelectionHelper' => $baseDir . '/src/Services/BandaSelectionHelper.php',
    'CategoriaController' => $baseDir . '/src/Controllers/CategoriaController.php',
    'CategoriaFormValidator' => $baseDir . '/src/Services/CategoriaFormValidator.php',
    'CategoriaRepository' => $baseDir . '/src/Repositories/CategoriaRepository.php',
    'ChordImportProvider' => $baseDir . '/src/Services/ChordImportProvider.php',
    'ChordImportProviderResolver' => $baseDir . '/src/Services/ChordImportProviderResolver.php',
    'ChordSaveNormalizer' => $baseDir . '/src/Services/ChordSaveNormalizer.php',
    'CifraClubImportProvider' => $baseDir . '/src/Services/CifraClubImportProvider.php',
    'ClosedBetaPolicy' => $baseDir . '/src/Services/ClosedBetaPolicy.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'CompromisedPasswordChecker' => $baseDir . '/src/Services/CompromisedPasswordChecker.php',
    'ConfigController' => $baseDir . '/src/Controllers/ConfigController.php',
    'Database' => $baseDir . '/src/Services/Database.php',
    'DatabaseBackupService' => $baseDir . '/src/Services/DatabaseBackupService.php',
    ...
    'EditorController' => $baseDir . '/src/Controllers/EditorController.php',
    'GoogleAuthService' => $baseDir . '/src/Services/GoogleAuthService.php',
    'GoogleCallbackValidator' => $baseDir . '/src/Services/GoogleCallbackValidator.php',
    'GoogleJwtVerifier' => $baseDir . '/src/Services/GoogleJwtVerifier.php',
    'HomeController' => $baseDir . '/src/Controllers/HomeController.php',
    'IndexController' => $baseDir . '/src/Controllers/IndexController.php',
    'LivePlayerController' => $baseDir . '/src/Controllers/LivePlayerController.php',
    'LiveStateRepository' => $baseDir . '/src/Repositories/LiveStateRepository.php',
    'LiveStateService' => $baseDir . '/src/Services/LiveStateService.php',
    'MailService' => $baseDir . '/src/Services/MailService.php',
    'MusicController' => $baseDir . '/src/Controllers/MusicController.php',
    'MusicaRepository' => $baseDir . '/src/Repositories/MusicaRepository.php',
    'OfflineController' => $baseDir . '/src/Controllers/OfflineController.php',
    'OperationalLogger' => $baseDir . '/src/Services/OperationalLogger.php',
    ...
    'PasswordResetFlow' => $baseDir . '/src/Services/PasswordResetFlow.php',
    'PasswordResetValidator' => $baseDir . '/src/Services/PasswordResetValidator.php',
    ...
    'PlanoViewModel' => $baseDir . '/src/Services/PlanoViewModel.php',
    'PlaylistController' => $baseDir . '/src/Controllers/PlaylistController.php',
    'PlaylistFormValidator' => $baseDir . '/src/Services/PlaylistFormValidator.php',
    'PlaylistRepository' => $baseDir . '/src/Repositories/PlaylistRepository.php',
    'PrivacyService' => $baseDir . '/src/Services/PrivacyService.php',
    'RegisterController' => $baseDir . '/src/Controllers/RegisterController.php',
    'RoteiroController' => $baseDir . '/src/Controllers/RoteiroController.php',
    'RoteiroFormValidator' => $baseDir . '/src/Services/RoteiroFormValidator.php',
    'RoteiroRepository' => $baseDir . '/src/Repositories/RoteiroRepository.php',
    ...
    'SongController' => $baseDir . '/src/Controllers/SongController.php',
    'StripeCheckoutHelper' => $baseDir . '/src/Services/StripeCheckoutHelper.php',
    'StripeWebhookHelper' => $baseDir . '/src/Services/StripeWebhookHelper.php',
    'SyncConflictException' => $baseDir . '/src/Services/SyncConflictException.php',
    'SyncRevisionRepository' => $baseDir . '/src/Repositories/SyncRevisionRepository.php',
    ...
    'TomController' => $baseDir . '/src/Controllers/TomController.php',
    'UserConfigValidator' => $baseDir . '/src/Services/UserConfigValidator.php',
    'UserFormValidator' => $baseDir . '/src/Services/UserFormValidator.php',
    'UserRepository' => $baseDir . '/src/Repositories/UserRepository.php',
    'UsersController' => $baseDir . '/src/Controllers/UsersController.php',
    'Validator' => $baseDir . '/src/Services/Validator.php',
    'YoutubeAudioDownloadService' => $baseDir . '/src/Services/YoutubeAudioDownloadService.php',
);
