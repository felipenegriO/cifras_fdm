<?php
/**
 * SVG icon helper — Lucide-style outline icons.
 * Uso: <?= cifro_icon('trash') ?>
 */
function cifro_icon($name, $size = 16, $extraClass = '') {
    $icons = [
        ...
        'eraser'   => '<path d="M20 20H7L3 16c-1-1-1-2 0-3l7-7 8 8-7 7"/><path d="M14 12l3-3"/>',
    ...
    return '<svg width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"' . $cls . '>' . $path . '</svg>';
}
