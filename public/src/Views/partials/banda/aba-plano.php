<?php
/**
 * Aba Plano do "Minha Banda".
 * Recorte de Views/plano.php, sem redesenho: mesma marcação, mesmo
...
<style>
    ...
    .plan-wrap h2.mb-aba-titulo { font-size: var(--text-xl); font-weight: var(--fw-bold); margin: 0 0 var(--space-4); }
...
<div class="plan-wrap">
  <h2 class="mb-aba-titulo"><?= $isPago ? 'Plano e pagamento' : 'Meu Plano' ?></h2>
