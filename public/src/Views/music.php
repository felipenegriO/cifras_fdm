...
<body class="music-page<?= (($_GET['editorPreview'] ?? '') === '1') ? ' is-editor-preview' : '' ?>">
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var src = document.getElementById('tom');
            var dst = document.getElementById('mbbTom');
    ...
    <script>
        ...
        function groupSectionBlocks(container) {
            // Remove <br> entre dois elementos do mesmo tipo de seção
            // para que o background apareça como um bloco contínuo
